...
class CustomerData  {
    constructor(customer){
        ...
        this.fuelType = customer['Fuel'].trim() ,
        this.vehicleSegment = customer['VEHICLE_SEGMENT'].trim() ,
        ...
        this.customerRegion = customer['Customer_Region'].trim() ,
        this.customerMaritalStatus = customer['Customer_Marital_status'].trim(),
